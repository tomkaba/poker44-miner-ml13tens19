...
class Miner(BaseMinerNeuron):
    ...
    def __init__(self, config=None):
        ...
        self.model_manifest = build_local_model_manifest(
            ...
            implementation_files=[
                repo_root / "weights" / "gen13_tens19_170_3_hardened.ts",
            ...
            defaults={
                "model_name": "poker44_ml13tens19",
                "model_version": "13.19",
                "framework": "pytorch-torchscript",
                "license": "MIT",
                "repo_url": "https://github.com/tomkaba/poker44-miner-ml13tens19",
                "repo_commit": git_commit,
                "notes": "Gen13Tens19 neural network scorer (POT=170, AAF=3)",
                "open_source": True,
    ...
    async def forward(self, synapse: DetectionSynapse) -> DetectionSynapse:
        ...
        synapse.predictions = [s >= 0.019 for s in scores]
        ...
        bt.logging.info(f"Scored {len(chunks)} chunks with scorer ml13tens19.")
        return synapse
...
if __name__ == "__main__":
    ...
    with Miner() as miner:
        ...
        while True:
            bt.logging.info(
                f"Miner UID: {miner.uid} | Incentive: {float(miner.metagraph.I[miner.uid])} | Scorer: ml13tens19"
            )
            time.sleep(60)
